...
const AuthoritiesSearchContextProvider = ({
  ...
  const initialSearchInputValue = searchParams.query || initialValues.searchInputValue || '';
  const initialSearchQuery = searchParams.query || initialValues.searchQuery || '';
  ...
  const setNavigationSegmentValue = value => {
    ...
    setSearchDropdownValue(params?.dropdownValue || initialValues.dropdownValue || defaultDropdownValueBySegment[value]);
    setSearchIndex(params?.searchIndex || initialValues.searchIndex || defaultDropdownValueBySegment[value]);
    setFilters(params?.filters || initialValues.filters || {});
