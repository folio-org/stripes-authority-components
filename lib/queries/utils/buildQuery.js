...
export const getQueryStrings = (indexData, queryTemplate, filters, seeAlsoJoin = 'or') => {
...
const buildQuery = ({
  ...
  const queryStrings = getQueryStrings(indexData, queryTemplate, filters, seeAlsoJoin);
