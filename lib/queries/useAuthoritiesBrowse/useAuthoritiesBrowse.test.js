...
describe('Given useAuthoritiesBrowse', () => {
  ...
  it('should fetch main page', async () => {
    ...
    const { result } = renderHook(() => useAuthoritiesBrowse({
      filters,
      searchQuery: '"test"',
      searchIndex,
      pageSize,
  ...
  describe('when search query changes', () => {
    it('should request new data', async () => {
      ...
      const { result, rerender } = renderHook(useAuthoritiesBrowse, {
        initialProps,
        wrapper,
      });
  ...
  describe('when the user navigates to another route', () => {
    it('should not reset browsePageQuery', async () => {
      ...
      const { result, rerender } = renderHook(useAuthoritiesBrowse, { initialProps, wrapper });
