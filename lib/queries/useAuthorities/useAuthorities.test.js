...
describe('Given useAuthorities', () => {
  ...
  describe('when sort options are presented', () => {
    ...
    describe('when sorted column and sort order is empty', () => {
      it('should add "sortBy headingRef/sort.ascending" to query', async () => {
        const { result } = renderHook(() => useAuthorities({
          searchQuery,
          searchIndex,
          filters: {},
        ...
        expect(result.current.query).toEqual('(keyword all "test" or naturalId=="test" or identifiers.value=="test") sortBy headingRef/sort.ascending');
      });

      describe('when search parameters are empty', () => {
        it('should return an empty query', async () => {
          const { result } = renderHook(() => useAuthorities({
            searchQuery: '',
            searchIndex,
            filters: {},
  ...
  describe('when search by identifier', () => {
    it('should return correct query string', async () => {
      ...
      expect(result.current.query).toEqual(expect.stringContaining(
  ...
  it('should have escaped query', async () => {
    ...
    expect(result_.current.query).toEqual(expect.stringContaining(
  ...
  describe('when the "Subject" search option is opted', () => {
    it('should build correct search query', async () => {
      ...
      expect(result_.current.query).toEqual(expect.stringContaining('(topicalTerm all "test" or sftTopicalTerm all "test"' +
  ...
  describe('when the "Subject" search option is opted', () => {
    describe('and both filters "Exclude see from" and "Exclude see from also" are selected', () => {
      it('should build search query without sftTopicalTerm and saftTopicalTerm', async () => {
        ...
        expect(result_.current.query).toEqual(expect.stringContaining('(topicalTerm all "test" or namedEvent all "test"' +
  ...
  describe('when isAdvancedSearch prop is true', () => {
    ...
    describe('when the "Subject" search option is opted', () => {
      it('should build correct search query', async () => {
        ...
        expect(result_.current.query).toEqual(expect.stringContaining('(topicalTerm all "test1" or sftTopicalTerm all "test1"' +
    ...
    describe('when the "Subject" search option is opted', () => {
      describe('and both filters "Exclude see from" and "Exclude see from also" are selected', () => {
        it('should build search query without sftTopicalTerm and saftTopicalTerm', async () => {
          ...
          expect(result_.current.query).toEqual(expect.stringContaining('(topicalTerm all "test1" or namedEvent all "test1"' +
