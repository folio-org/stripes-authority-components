...
describe('Given useAuthorities', () => {
  ...
  describe('when the "Subject" search option is opted', () => {
    it('should build correct search query', async () => {
      ...
      expect(result_.current.query).toBe(
        '(topicalTerm all "test" or sftTopicalTerm all "test" or saftTopicalTerm all "test"' +
        ' or namedEvent all "test" or sftNamedEvent all "test" or saftNamedEvent all "test"' +
        ' or generalSubdivision all "test" or sftGeneralSubdivision all "test" or saftGeneralSubdivision all "test"' +
        ')',
      );
    });
  });
  ...
  describe('when the "Subject" search option is opted', () => {
    describe('and both filters "Exclude see from" and "Exclude see from also" are selected', () => {
      it('should build search query without sftTopicalTerm and saftTopicalTerm', async () => {
        ...
        expect(result_.current.query).toBe(
          '(topicalTerm all "test" or namedEvent all "test" or generalSubdivision all "test") and (authRefType==("Authorized"))',
        );
      });
    });
  });
    ...
    describe('when the "Subject" search option is opted', () => {
      it('should build correct search query', async () => {
        ...
        expect(result_.current.query).toBe(
          ...
          ' or namedEvent all "test1" or sftNamedEvent all "test1" or saftNamedEvent all "test1"' +
          ' or generalSubdivision all "test1" or sftGeneralSubdivision all "test1" or saftGeneralSubdivision all "test1")' +
          ...
          ' or sftGeneralSubdivision=="test2" or saftGeneralSubdivision=="test2")' +
          ' not (topicalTerm any "test3" or sftTopicalTerm any "test3" or saftTopicalTerm any "test3"' +
          ' or namedEvent any "test3" or sftNamedEvent any "test3" or saftNamedEvent any "test3"' +
          ' or generalSubdivision any "test3" or sftGeneralSubdivision any "test3"' +
          ' or saftGeneralSubdivision any "test3")' +
          ' and (topicalTerm all "test4*" or sftTopicalTerm all "test4*"' +
          ' or saftTopicalTerm all "test4*" or namedEvent all "test4*" or sftNamedEvent all "test4*"' +
          ' or saftNamedEvent all "test4*" or generalSubdivision all "test4*" or sftGeneralSubdivision all "test4*"' +
          ' or saftGeneralSubdivision all "test4*")',
        );
      });
    });
    ...
    describe('when the "Subject" search option is opted', () => {
      describe('and both filters "Exclude see from" and "Exclude see from also" are selected', () => {
        it('should build search query without sftTopicalTerm and saftTopicalTerm', async () => {
          ...
          expect(result_.current.query).toBe(
            '(topicalTerm all "test1" or namedEvent all "test1" or generalSubdivision all "test1")' +
            ' or (topicalTerm=="test2" or namedEvent=="test2" or generalSubdivision=="test2")' +
            ' not (topicalTerm any "test3" or namedEvent any "test3" or generalSubdivision any "test3")' +
